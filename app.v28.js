/* app.v28.js — HR Chat UI forced refresh
   Time: 2025-10-07 10:40:20
*/
;(() => {
  try {
    document.addEventListener('DOMContentLoaded', () => {
      const b = document.getElementById('build'); if (b) b.textContent = 'v28';
      const l = document.getElementById('loading'); if (l) l.textContent = '';
      console.log('[HR] app.v28 boot @', new Date().toISOString());
    });
  } catch(e) { console.warn('v28 guard', e); }
})();
;(() => {
  try{
    document.addEventListener('DOMContentLoaded', () => {
