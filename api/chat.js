...
module.exports = async function (req, res) {
  ...
  try {
    ...
    const policy = [{
      role: 'system',
      content: 'You are GPT-5 Thinking, a California mortgage guide. Educational only; not a commitment to lend. State assumptions. Tailor to CA rules for Access Zero, DSCR, Jumbo Advantage, FHA/VA. No emojis.'
    }];
