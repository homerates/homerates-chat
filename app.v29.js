/* app.v29.js — HR Chat UI forced refresh
   Deployed: 2025-10-07 11:02:01
*/
;(() => {
  try {
    document.addEventListener('DOMContentLoaded', () => {
      const b = document.getElementById('build'); if (b) b.textContent = 'v29';
      const l = document.getElementById('loading'); if (l) l.textContent = '';
      console.log('[HR] app.v29 boot @', new Date().toISOString());
    });
  } catch(e) { console.warn('v29 guard', e); }
})();
;(() => {
  try{
    document.addEventListener('DOMContentLoaded', () => {
